...
/*!*************************************!*\
  !*** ./js/components/components.js ***!
  \*************************************/
/*! exports provided: initCustomComponents */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCustomComponents", function() { return initCustomComponents; });
var _require = __webpack_require__(/*! ./row-component */ "./js/components/row-component.js"),
  RowComponent = _require.RowComponent;
var initCustomComponents = function initCustomComponents() {
  customElements.define('row-component', RowComponent);
};

/***/ }),

/***/ "./js/components/row-component.js":
/*!****************************************!*\
  !*** ./js/components/row-component.js ***!
  \****************************************/
...
var RowComponent = /*#__PURE__*/function (_HTMLElement) {
  _inherits(RowComponent, _HTMLElement);
  ...
  _createClass(RowComponent, [{
    ...
    value: function _generateTemplate() {
      this.rowTemplate = "\n      <div class=\"color-picker__table-cell\">\n        <div class=\"color-picker__table-color-example\" style=\"background-color: ".concat(this.colorSet.colorHex, "\"></div>\n      </div>\n      <div class=\"color-picker__table-cell\">\n        <p class=\"color-picker__table-text text\">").concat(this.colorSet.colorName, "</p>\n      </div>\n      <div class=\"color-picker__table-cell\">\n        <p class=\"color-picker__table-text text\">").concat(this.colorSet.colorType, "</p>\n      </div>\n      <div class=\"color-picker__table-cell\">\n        <p class=\"color-picker__table-text text\">").concat(this.colorSet.colorHex, "</p>\n      </div>\n      <div class=\"color-picker__table-cell\">\n        <button class=\"btn btn--hover-blue\" data-table-btn=\"change\" type=\"button\" aria-label=\"\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C\">\n          <svg width=\"20\" height=\"20\" aria-hidden=\"true\">\n            <use xlink:href=\"img/sprite.svg#icon-pen\"></use>\n          </svg> \n        </button>\n      </div>\n      <div class=\"color-picker__table-cell\">\n        <button class=\"btn btn--hover-sunset\" data-table-btn=\"delete\" type=\"button\" aria-label=\"\u0423\u0434\u0430\u043B\u0438\u0442\u044C\">\n          <svg width=\"20\" height=\"20\" aria-hidden=\"true\">\n            <use xlink:href=\"img/sprite.svg#icon-bin\"></use>\n          </svg>\n        </button>\n      </div>");
      return this.rowTemplate;
    }
  }, {
    key: "_getColorSetData",
    value: function _getColorSetData() {
      this.colorSet = JSON.parse(this.getAttribute('color-set'));
    }
  }, {
    key: "_updateTemplate",
    value: function _updateTemplate() {
      this.colorSet = JSON.parse(this.getAttribute('color-set'));
    ...
    value: function connectedCallback() {
      ...
      this.setAttribute('data-table-row', "".concat(this.colorSet.id));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/components */ "./js/components/components.js");
/* harmony import */ var _modules_init_color_picker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-color-picker */ "./js/modules/init-color-picker.js");
/* harmony import */ var _modules_init_color_sets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-color-sets */ "./js/modules/init-color-sets.js");
/* harmony import */ var _modules_init_drag_drop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-drag-drop */ "./js/modules/init-drag-drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_components_components__WEBPACK_IMPORTED_MODULE_0__["initCustomComponents"])();
  window.addEventListener('load', function () {
    Object(_modules_init_drag_drop__WEBPACK_IMPORTED_MODULE_3__["initDragDrop"])();
    Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_4__["initModals"])();
    Object(_modules_init_color_picker__WEBPACK_IMPORTED_MODULE_1__["initColorPicker"])();
    Object(_modules_init_color_sets__WEBPACK_IMPORTED_MODULE_2__["initColorSets"])();
  });
});
...
var ColorSet = /*#__PURE__*/function () {
  ...
  _createClass(ColorSet, [{
    ...
    value: function addColorSet(colorSet) {
      var trow = document.createElement('row-component');
      trow.setAttribute('color-set', "".concat(JSON.stringify(colorSet)));
    ...
    key: "changeColorSet",
    value: function changeColorSet(colorSet) {
      this.tbody.querySelector("[data-table-row=\"".concat(colorSet.id, "\"]")).setAttribute('color-set', "".concat(JSON.stringify(colorSet)));
      this.tbody.querySelector("[data-table-row=\"".concat(colorSet.id, "\"]")).dispatchEvent(new Event('updateSet'));
    }
    ...
    value: function deleteColorSet() {
      ...
      if (this.tbody.querySelectorAll('[data-table-row]').length <= 1) {
        _init_drag_drop__WEBPACK_IMPORTED_MODULE_1__["dragDrop"].unInit();
      }
    }
    ...
    value: function onOrderChange() {
      ...
      trows.forEach(function (row) {
        var element = _this3.colorSets.find(function (set) {
          return row.dataset.tableRow === set.id.toString();
        });
    ...
    value: function onAddColorClick() {
      ...
      _init_color_picker__WEBPACK_IMPORTED_MODULE_0__["picker"].setColor('#fff');
    }
    ...
    value: function onChangeColorClick(_ref2) {
      ...
      var id = target.closest('[data-table-row]').dataset.tableRow;
      var set = this.colorSets.find(function (set) {
      ...
      _init_color_picker__WEBPACK_IMPORTED_MODULE_0__["picker"].setColor(set.colorHex);
      this.colorSetData = {
        id: id,
